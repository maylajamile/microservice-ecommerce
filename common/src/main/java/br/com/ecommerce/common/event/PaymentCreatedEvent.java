...
public class PaymentCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5761024228808722314L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"PaymentCreatedEvent\",\"namespace\":\"br.com.ecommerce.common.event\",\"fields\":[{\"name\":\"checkoutCode\",\"type\":[\"string\"]},{\"name\":\"checkoutStatus\",\"type\":[\"string\"]},{\"name\":\"paymentCode\",\"type\":[\"string\"]}]}");
   ...
   */
  public static br.com.ecommerce.common.event.PaymentCreatedEvent.Builder newBuilder() {
    return new br.com.ecommerce.common.event.PaymentCreatedEvent.Builder();
  }
   ...
   * @return A new PaymentCreatedEvent RecordBuilder
   */
  public static br.com.ecommerce.common.event.PaymentCreatedEvent.Builder newBuilder(br.com.ecommerce.common.event.PaymentCreatedEvent.Builder other) {
    if (other == null) {
      return new br.com.ecommerce.common.event.PaymentCreatedEvent.Builder();
    } else {
      return new br.com.ecommerce.common.event.PaymentCreatedEvent.Builder(other);
    }
  }
   ...
   * @return A new PaymentCreatedEvent RecordBuilder
   */
  public static br.com.ecommerce.common.event.PaymentCreatedEvent.Builder newBuilder(br.com.ecommerce.common.event.PaymentCreatedEvent other) {
    if (other == null) {
      return new br.com.ecommerce.common.event.PaymentCreatedEvent.Builder();
    } else {
      return new br.com.ecommerce.common.event.PaymentCreatedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentCreatedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(br.com.ecommerce.common.event.PaymentCreatedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(br.com.ecommerce.common.event.PaymentCreatedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.checkoutCode)) {
        this.checkoutCode = data().deepCopy(fields()[0].schema(), other.checkoutCode);
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.ecommerce.common.event.PaymentCreatedEvent.Builder setCheckoutCode(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.ecommerce.common.event.PaymentCreatedEvent.Builder clearCheckoutCode() {
      checkoutCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.ecommerce.common.event.PaymentCreatedEvent.Builder setCheckoutStatus(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.ecommerce.common.event.PaymentCreatedEvent.Builder clearCheckoutStatus() {
      checkoutStatus = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.ecommerce.common.event.PaymentCreatedEvent.Builder setPaymentCode(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.ecommerce.common.event.PaymentCreatedEvent.Builder clearPaymentCode() {
      paymentCode = null;
